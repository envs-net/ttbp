...
[git.envs.net](https://git.envs.net/envs/ttbp).
...
conduct](http://envs.net/wiki/code-of-conduct). content/personal issues should be
worked out according to the CoC, with support from the [administrative
team](https://envs.net/wiki/code-of-conduct#9--contact-info) if needed.

### support

if you're having trouble getting started, or run into program errors or strange
behavior, please ask in [#envs:envs.net](https://matrix.to/#/#envs:envs.net) (on matrix) or send a mail
to [sudoers@envs.net](mailto:sudoers@envs.net) and we'll try to
sort things out!
